...
getLoginR = do
           ...
           |] 
           defaultLayout $
                toWidget $(luciusFile "template/css.lucius") >>
                $(whamletFile "template/home.hamlet")
...
--connStr = "dbname=d44ad2c52pllg5 host=ec2-23-21-165-183.compute-1.amazonaws.com user=fxrcsnghafllog password=d0zf-NvDxQLWwixp7bzdnc88xO port=5432"
