...
getHomeR = do
     ...
     defaultLayout (hamletFile  "home.hamlet")
...
--http://www.yesodweb.com/blog/2013/01/adding-css-js
...
--transforma o valor da session de texto para string (unpack), de string para int (read) e de int para chave (toSqlKey)
--            uid <- return (toSqlKey $ read $ unpack sess) :: Handler (Key Users)
